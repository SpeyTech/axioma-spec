...
**Version:** v0.2 — Audit-Frozen Candidate
**Status:** Production Gold
**Supersedes:** SRS-001 v0.1
...
| v0.2 | Audit-Frozen Candidate | Genesis requirement, physical I/O fault handling, input domain validation, toolchain provenance |
...
*SRS-001 v0.2 — Audit-Frozen Candidate*
